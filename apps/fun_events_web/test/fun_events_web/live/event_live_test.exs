defmodule FunEventsWeb.EventLiveTest do
  use FunEventsWeb.ConnCase

  import Phoenix.LiveViewTest
  import FunEvents.EventsFixtures

  @create_attrs %{date: "2023-06-05", name: "some name", status: "some status", time_zone: "some time_zone"}
  @update_attrs %{date: "2023-06-06", name: "some updated name", status: "some updated status", time_zone: "some updated time_zone"}
